...
export default function HouseholdError({
  ...
  useEffect(() => {
    console.error('Household portal error:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          Household Portal Error
        </h1>
        <p className="text-gray-600 mb-6">
          An error occurred in the household portal. Please try again or return to your dashboard.
        </p>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/household/dashboard" className="hh-btn hh-btn-secondary">
            Go to Dashboard
          </Link>
        </div>
      </div>
